export default {
          ...
          florida: [
            {
              ...
              description:
                'We are a collective of software engineers, programmers, and designers in the Tampa Bay Area.',
  ...
  itBased: [
    ...
    },
    {
      ...
      description:
        "Get your API, REST and HTTP questions answered! We're the larrgest API-centric Slack channel around.",
      url: 'https://slack.apisyouwonthate.com/',
    },
    {
      name: 'HackerX',
      description:
        "A community of hackers and makers from all over the world to facilitate networking, Q&A's, feedback and more.",
